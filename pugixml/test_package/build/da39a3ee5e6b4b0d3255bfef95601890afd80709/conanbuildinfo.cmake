set(CONAN_PUGIXML_ROOT "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9")
set(CONAN_INCLUDE_DIRS_PUGIXML "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/include")
set(CONAN_LIB_DIRS_PUGIXML "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/lib")
set(CONAN_BIN_DIRS_PUGIXML "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/bin")
set(CONAN_RES_DIRS_PUGIXML "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/res")
set(CONAN_BUILD_DIRS_PUGIXML "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/")
...
set(CONAN_DEPENDENCIES pugixml)
...
set(CONAN_INCLUDE_DIRS "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/bin" ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/res" ${CONAN_RES_DIRS})
set(CONAN_LIBS pugixml ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/home/alexandru/.conan/data/pugixml/1.8.1/popescu-af/testing/package/81607951755e61cf17149d40bed6aba5b3a079a9/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_find_libraries_abs_path("${CONAN_LIBS_PUGIXML}" "${CONAN_LIB_DIRS_PUGIXML}"
                                  CONAN_FULLPATH_LIBS_PUGIXML)
    conan_find_libraries_abs_path("${CONAN_LIBS_PUGIXML_DEBUG}" "${CONAN_LIB_DIRS_PUGIXML_DEBUG}"
                                  CONAN_FULLPATH_LIBS_PUGIXML_DEBUG)
    conan_find_libraries_abs_path("${CONAN_LIBS_PUGIXML_RELEASE}" "${CONAN_LIB_DIRS_PUGIXML_RELEASE}"
                                  CONAN_FULLPATH_LIBS_PUGIXML_RELEASE)

    add_library(CONAN_PKG::pugixml INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::pugixml PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_FULLPATH_LIBS_PUGIXML} ${CONAN_SHARED_LINKER_FLAGS_PUGIXML_LIST} ${CONAN_EXE_LINKER_FLAGS_PUGIXML_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_FULLPATH_LIBS_PUGIXML_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_PUGIXML_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_PUGIXML_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_FULLPATH_LIBS_PUGIXML_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_PUGIXML_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_PUGIXML_DEBUG_LIST}>
                                                                 )
    ...
    set(CONAN_TARGETS CONAN_PKG::pugixml)
